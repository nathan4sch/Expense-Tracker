...
// Everything from https://fonts.google.com/
...
export const invest = <i className="fa-solid fa-display-chart-up"></i>

//income icons
export const money = <i className="fa-solid fa-money-bill"></i>
export const sideHustle = <i className="fa-solid fa-money-bill-wave"></i>
...
export const utilities = <i className="fa-solid fa-bolt"></i>
export const food = <i className="fa-solid fa-bowl-food"></i>
export const insurance = <i className="fa-solid fa-car-burst"></i>
export const healthcare = <i className="fa-solid fa-user-nurse"></i>
